...
fn day2() {
    ...
    impl PolicyAndPassword {
        ...
        fn is_valid_part2(&self) -> bool {
            ...
            (self.password.chars().nth(valid_position1.try_into().unwrap()).unwrap() == self.letter) !=
                (self.password.chars().nth(valid_position2.try_into().expect("Couldn't convert valid_position2")).unwrap() == self.letter)
        }
    }
